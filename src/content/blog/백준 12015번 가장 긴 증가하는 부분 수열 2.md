...
## 아이디어
앞에서 풀어본 [[백준 11053번 가장 긴 증가하는 부분 수열|백준 11053번: 가장 긴 증가하는 부분 수열]]에서는 원소 하나의 길이를 결정할 때마다 앞에 있는 모든 값을 탐색해야만 했다. 따라서 시간복잡도는 O(N^2)인데 이러한 방법으로는 입력의 크기가 1,000,000인 12015번 문제를 풀 수 없다. 따라서 시간복잡도를 줄여야 한다.
