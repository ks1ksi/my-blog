---
title: "백준 3006번 터보소트"
description: "백준 3006번 터보소트 풀이. 세그먼트 트리로 남아 있는 원소 수를 세며 1, N, 2, N-1 순서의 이동 횟수를 계산한다."
date: 2021-12-01
tags:
  - "segment-tree"
  - "cpp"
...
[백준 3006번: 터보소트](https://www.acmicpc.net/problem/3006)

## 아이디어

이전 버블소트 문제에서 쿼리 날리는 순서를 바꾸기만 하면 풀 수 있다.
`0 ~ i`이랑 `N-1-i ~ N-1` 번갈아서 날려주면 1, N, 2, N-1 순서로 정렬 가능.
...
![[백준 3006번 터보소트-1-1888555a3e.jpeg]]
