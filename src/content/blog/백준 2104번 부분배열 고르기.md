---
title: "백준 2104번 부분배열 고르기"
description: "백준 2104번 부분배열 고르기 풀이. 구간 최솟값의 인덱스를 기준으로 분할 정복하며 부분배열 합과 최솟값의 곱을 최대화한다."
date: 2021-12-06
tags:
  - "divide-and-conquer"
  - "segment-tree"
...
[백준 2104번: 부분배열 고르기](https://www.acmicpc.net/problem/2104)

## 아이디어
히스토그램 문제랑 푸는 방법이 정확히 일치한다. 높이 가장 작은거 골라서 걔 기준으로 왼쪽, 오른쪽 분할정복.
...
![[백준 2104번 부분배열 고르기-1-dce1e28b26.jpeg]]

## 여담
> 최솟값의 **인덱스**를 저장해야 한다는 사실..! 그리고 long long 안쓰면 오버플로우.
